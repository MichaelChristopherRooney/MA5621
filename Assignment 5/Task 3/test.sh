...
declare -a GREP_RESULTS=(
	"aaaKEYWORDbbbaaKEYWORDcc " "\x1B[32m1:\x1B[0maaaKEYWORDbbbaaKEYWORDcc " "cccdddeeefff " 
	"aaa\x1B[31mKEYWORD\x1B[0mbbbaa\x1B[31mKEYWORD\x1B[0mcc " 
	"ERROR: please provide a word to search for " "ERROR: please provide a word to search for "
)
